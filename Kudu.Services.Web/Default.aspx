...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="KuduExec" target="_newtab">Launch</a>&nbsp;&nbsp;This is an experimental feature.</td>
        </tr>
        <tr>
            <td><strong>Diagnostic log stream</strong></td>
            <td><a href="logstream" target="_newtab">Stream</a>&nbsp;&nbsp;If no log events are being generated the page may not load.</td>
        </tr>
    ...
    <table>
        <tr>
            ...
            <td><a href="deployments" target="_newtab">Browse</a></td>
        </tr>
        <tr>
            <td><strong>Files</strong></td>
            <td><a href="vfs" target="_newtab">Browse</a></td>
        </tr>
        <tr>
            <td><strong>App settings</strong></td>
            <td><a href="settings" target="_newtab">Browse</a></td>
        </tr>
        <tr>
            <td><strong>Processes and mini-dumps</strong></td>
            <td><a href="diagnostics/processes" target="_newtab">Browse</a></td>
        </tr>
        <tr>
            <td><strong>Source control info</strong></td>
            <td><a href="scm/info" target="_newtab">Browse</a></td>
        </tr>
    </table>
</body>
</html>
