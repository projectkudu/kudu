...
namespace Kudu.TestHarness
{
    public class TestRepository : IDisposable
    {
        ...
        public TestRepository(string repositoryName, bool obliterateOnDispose)
        {
            ...
            _repository = new LibGit2SharpRepository(_environment, settingManager, NullTracerFactory.Instance, new PermissionHandler(_environment, settingManager, NullLogger.Instance));
