...
namespace Kudu.TestHarness
{
    internal class TestRepositories
    {
        ...
        private static TestRepositoryInfo[] _repoList = new TestRepositoryInfo[]
        {
            ...
            new TestRepositoryInfo("https://github.com/KuduApps/AspNet5With2ProjectsAndSlnFile.git","282b7a7"),
            new TestRepositoryInfo("https://github.com/KuduApps/AspNet5With2ProjectsNoSlnFile.git", "5be9c77"),
