...
namespace Kudu.TestHarness
{
    internal class TestRepositories
    {
        ...
        private static TestRepositoryInfo[] _repoList = new TestRepositoryInfo[]
        {
            ...
            new TestRepositoryInfo("https://github.com/KuduApps/AspNet5With2ProjectsAndSlnFile.git","fa2d024"),
            new TestRepositoryInfo("https://github.com/KuduApps/AspNet5With2ProjectsNoSlnFile.git", "c2e9c28"),
            ...
            new TestRepositoryInfo("https://github.com/KuduApps/MvcAppWithTypeScript.git",          "cc406e0"),
