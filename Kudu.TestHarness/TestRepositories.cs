...
namespace Kudu.TestHarness
{
    internal class TestRepositories
    {
        ...
        private static TestRepositoryInfo[] _repoList = new TestRepositoryInfo[]
        {
            ...
            new TestRepositoryInfo("https://github.com/KuduApps/AspNet5With2ProjectsAndSlnFile.git","9a5e11f"),
            new TestRepositoryInfo("https://github.com/KuduApps/AspNet5With2ProjectsNoSlnFile.git", "ce994c7"),
