...
namespace Kudu.TestHarness
{
    internal class TestRepositories
    {
        ...
        private static TestRepositoryInfo[] _repoList = new TestRepositoryInfo[]
        {
            ...
            new TestRepositoryInfo("https://github.com/KuduApps/AspNetCoreRC2Yeoman2Projects.git",  "63524aa"),
            new TestRepositoryInfo("https://github.com/KuduApps/AspNetCoreRC2YeomanProject.git",    "75a7ee8"),
            new TestRepositoryInfo("https://github.com/KuduApps/AspNetCoreRC2VisualStudioSln.git",  "b03736a"),
