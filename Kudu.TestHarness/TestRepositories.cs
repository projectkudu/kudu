...
namespace Kudu.TestHarness
{
    internal class TestRepositories
    {
        ...
        private static TestRepositoryInfo[] _repoList = new TestRepositoryInfo[]
        {
            ...
            new TestRepositoryInfo("https://github.com/KuduApps/DotNetCore60PreviewWeb",            "be6ff2b"),
            new TestRepositoryInfo("https://github.com/KuduApps/DotNetCore60PreviewConsole",        "be3f38e"),
