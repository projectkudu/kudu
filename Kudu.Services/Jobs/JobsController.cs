...
namespace Kudu.Services.Jobs
{
    ...
    public class JobsController : ApiController
    {
        ...
        {
            IEnumerable<ContinuousJob> continuousJobs = _continuousJobsManager.ListJobs(false);
            IEnumerable<TriggeredJob> triggeredJobs = _triggeredJobsManager.ListJobs(false);
