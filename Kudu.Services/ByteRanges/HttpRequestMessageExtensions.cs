...
namespace Kudu.Services.ByteRanges
{
    ...
    internal static class HttpRequestMessageExtensions
    {
        ...
        public static HttpResponseMessage CreateErrorResponseRangeNotSatisfiable(this HttpRequestMessage request, InvalidByteRangeException invalidByteRangeException)
        {
