...
{
    class AspNetCoreNewMSBuildBuilder : MicrosoftSiteBuilder
    {
        private readonly string _version;

        public AspNetCoreNewMSBuildBuilder(IEnvironment environment, IDeploymentSettingsManager settings, IBuildPropertyProvider propertyProvider, string sourcePath, string projectFilePath, string solutionPath)
