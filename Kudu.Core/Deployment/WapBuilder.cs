    ...
    public class WapBuilder : SolutionBasedSiteBuilder {
        ...
        protected override Task BuildProject(string outputPath, ILogger logger) {
            ...
            try {
                ...
                string log = ExecuteMSBuild(@"""{0}"" /nologo /verbosity:m /t:pipelinePreDeployCopyAllFilesToOneFolder /p:_PackageTempDir={1};AutoParameterizationWebConfigConnectionStrings=false;SolutionDir={2}", _projectPath, outputPath, solutionDir);
