...
namespace Kudu.Core.Deployment
{
    public interface IDeploymentManager
    {
        ...
        Task<DeployResult> DeployAsync(IRepository repository, ChangeSet changeSet, string deployer, bool clean, DeploymentInfoBase deploymentInfo = null, bool needFileUpdate = true, bool fullBuildByDefault = true);
